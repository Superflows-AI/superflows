...
export function getSearchDocsAction(
  ...
  return {
    ...
    filtering_description: `Searches over the ${org.name} documentation. Use this when asked how-to questions, how the system works or the meaning of terminology`,
