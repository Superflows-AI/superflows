...
6. It's CRUCIAL to call the API efficiently and don't make the same API call multiple times. DO NOT call APIs in a loop, unless it's wrapped in a promise
